...
<template>
  <AppLayout title="Modul aplikasi" subtitle="Fitur yang tersedia sesuai izin akses Anda dan peta modul berikutnya.">
    <section class="panel roadmap-intro"><div class="roadmap-icon"><CheckCircle2 :size="23" aria-hidden="true" /></div><div><h2>Absensi, persetujuan, dan keuangan terhubung</h2><p>Login, dashboard, absensi, persetujuan, dan keuangan sudah terhubung ke backend. Pengumuman, laporan, serta ekspor akan hadir berikutnya.</p></div></section>
