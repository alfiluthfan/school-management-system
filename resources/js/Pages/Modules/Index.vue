...
<template>
  <AppLayout title="Modul aplikasi" subtitle="Fitur yang tersedia sesuai izin akses Anda dan peta modul berikutnya.">
    <section class="panel roadmap-intro"><div class="roadmap-icon"><CheckCircle2 :size="23" aria-hidden="true" /></div><div><h2>Absensi, persetujuan, keuangan, dan pengumuman terhubung</h2><p>Login, dashboard, absensi, persetujuan, keuangan, dan pengumuman terhubung ke backend. Laporan serta ekspor akan hadir berikutnya.</p></div></section>
